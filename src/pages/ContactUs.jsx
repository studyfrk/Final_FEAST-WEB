            ...
            <div className="contact-form">
              <form>
                <div className="input-group">
                    ...
                    <input autocomplete="off" name="fullname" id="fullname" class="input" type="text" required />
                </div>
                <div className="input-group">
                ...
                <div className="input-group">
                    ...
                    <textarea autocomplete="off" name="message" id="message" className="input" required />
                </div>
              </form>
              <button type="submit">
