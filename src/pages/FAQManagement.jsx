      ...
      {showConfirm && (
        <div className={styles.contentModalOverlay} onClick={() => setShowConfirm(false)}>
          <div className={styles.faqConfirmCard} onClick={e => e.stopPropagation()}>
            <div className={styles.faqConfirmIcon}>
              <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#6d28d9" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round">
